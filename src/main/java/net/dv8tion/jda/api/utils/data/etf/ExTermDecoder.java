...
public class ExTermDecoder {
     ...
     * </ul>
     *
     * @param buffer The {@link ByteBuffer} containing the encoded term
     * @return The java object
     * @throws IllegalArgumentException If the buffer does not start with the version byte {@code 131} or contains an unsupported tag
     */
     ...
     * @throws IllegalArgumentException If the buffer does not start with a Map term, does not have the right version byte, or the format includes an unsupported tag
     */
     ...
     * @throws IllegalArgumentException If the buffer does not start with a List or NIL term, does not have the right version byte, or the format includes an unsupported tag
     */
    @SuppressWarnings("unchecked")
